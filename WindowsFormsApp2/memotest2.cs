...
{
    public partial class memotest2 : Form
    {
        bool allowClick = false; // define el click falso 
        PictureBox firstGuess; // variable del primer asierto 
        Random rnd = new Random();// generador de lugares random 
        Timer clickTimer = new Timer(); // crea la instancia de timer 
        int time = 60;
        Timer timer = new Timer { Interval = 1000 }; // 1000 milisegundos = 1 segundo
